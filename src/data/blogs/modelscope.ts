...
export const modelscopeBlog: BlogPost = {
  ...
  description:
    'Complete step-by-step technical guide to ModelScope AI inference on modelscope.ai, where legacy daily request limits are completely removed and replaced by Magicubes. Learn how to secure guaranteed 300 cubes daily (10-15M tokens) and configure GLM-5.2, DeepSeek-V4 Pro, and Qwen in OpenCode, Claude Code, Cursor, and Python.',
  ...
  notice: {
    type: 'warning',
    title: 'ModelScope Architecture: Legacy Quotas Removed, Magicubes Required',
    content:
      'ModelScope has completely eliminated the legacy daily and monthly request quotas (including the former 2,000 requests/day free tier). All model inference on `https://api-inference.modelscope.cn/v1` is now powered exclusively by Magicubes. Fortunately, every developer can easily guarantee 300 Magicubes every single day (fueling 10 to 15 million tokens of compute) in under two minutes through routine check-ins, likes, and comments.',
  },
  sections: [
    {
    ...
    },
    {
      ...
      title: '2. The Magicubes Economy: The Sole Engine for Model Inference',
      lead: 'Legacy fixed request quotas (e.g. 2,000 calls/day) have been completely deprecated and removed. Today, Magicubes (accessible at [modelscope.ai/magicube/usage?tab=earn](https://modelscope.ai/magicube/usage?tab=earn)) is the exclusive fuel for all model inference on ModelScope. Every token generated by DeepSeek-V4 Pro, GLM-5.2, or Qwen deducts Magicubes directly.',
      actionButton: {
      ...
      notice: {
        ...
        content:
          'Because Magicubes are the only way to run inference, establishing a daily claim routine is essential. Completing a 2-minute daily interaction (Login + Alibaba Cloud Binding + 20 Likes + 2 Comments) awards exactly 300 Magicubes every day. Due to ModelScope\'s competitive token pricing, 300 Magicubes easily powers 10 to 15 million tokens of high-end LLM inference.',
      },
      subsections: [
        {
    ...
    },
    {
      ...
      collapsible: {
        title: 'Token Consumption & Inference Limits',
        content:
          'ModelScope has retired legacy fixed request caps in favor of dynamic Magicube deduction:',
        list: [
          'No Fixed Request Caps: The former 2,000 total calls/day and 500 calls/model limits are completely removed.',
          ...
          'Zero Downtime Routine: By executing the 2-minute daily interaction routine, you perpetually maintain sufficient Magicubes to run coding agents without token starvation.',
        ],
      },
    },
    {
...
$env:ANTHROPIC_API_KEY = "dummy-key"`,
    ...
    },
    {
      ...
      unorderedList: [
        ...
        '**HTTP 402 / 429 Insufficient Magicubes**: Legacy fixed daily request quotas (such as 2,000 calls/day) have been retired. All inference requires Magicubes. If your requests fail with an insufficient balance error, execute the 2-minute daily routine (Login + Binding + 20 Likes + 2 Comments) on [https://modelscope.ai](https://modelscope.ai) to instantly claim 300 Magicubes (10–15 million tokens).',
